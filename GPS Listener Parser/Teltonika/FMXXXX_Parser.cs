    ...
    public class FMXXXX_Parser : ParserBase
    {
        ...
        {           
           ...
           // int dataLength = BitConverter.ToInt32(test, 0);
            ...
            //LoggerInLogger("Data Length: -----".PadRight(40, '-') + " "  + dataLength);
            int codecId = Convert.ToInt32(receiveBytes.Skip(8).Take(1).ToList()[0]);
            //LoggerInLogger("Codec ID: -----".PadRight(40, '-') + " "  + codecId);
            int numberOfData = Convert.ToInt32(receiveBytes.Skip(9).Take(1).ToList()[0]); ;
            //LoggerInLogger("Number of data: ----".PadRight(40, '-') + " "  + numberOfData);
            ...
            for (int n = 0; n < numberOfData; n++)
            {
                ...
                //LoggerInLogger("AKS-Timestamp: -----".PadRight(40, '-') + " "  + timestamp.ToLongDateString() + " " + timestamp.ToLongTimeString());

                int priority = Convert.ToInt32(receiveBytes.Skip(tokenAddress + 8).Take(1).ToList()[0]);
                //LoggerInLogger("AKS-Priority: ------------".PadRight(40, '-') + " "  + priority);
                ...
                //LoggerInLogger("AKS-Longtitude: -----".PadRight(40, '-') + " "  + longtitude);
                ...
                //LoggerInLogger("AKS-Latitude: -----".PadRight(40, '-') + " "  + latitude);
                ...
                //LoggerInLogger("AKS-Altitude: -----".PadRight(40, '-') + " "  + altitude);
                ...
                //LoggerInLogger("AKS-Angle: -----".PadRight(40, '-') + " "  + angle);

                int satellites = Convert.ToInt32(receiveBytes.Skip(tokenAddress + 21).Take(1).ToList()[0]);
                //LoggerInLogger("AKS-Satellites: -----".PadRight(40, '-') + " "  + satellites);
                ...
                //LoggerInLogger("AKS-Speed: -----".PadRight(40, '-') + " "  + speed);
                ...
                //LoggerInLogger("AKS-IO element ID of Event generated: ------".PadRight(40, '-') + " "  + event_IO_element_ID);

                int IO_element_in_record = Convert.ToInt32(receiveBytes.Skip(tokenAddress + 25).Take(1).ToList()[0]);
                //LoggerInLogger("AKS-IO_element_in_record: --------".PadRight(40, '-') + " "  + IO_element_in_record);
                ...
                if (IO_element_in_record != 0)
                {
                    ...
                    //LoggerInLogger("1 byte IO element in record: --------".PadRight(40, '-') + " "  + IO_Elements_1B_Quantity);
                    ...
                    for (int IO_1 = 0; IO_1 < IO_Elements_1B_Quantity; IO_1++)
                    {
                        ...
                        //LoggerInLogger("IO element 1B ID: --------".PadRight(40, '-') + " "  + parameterID);
                        //LoggerInLogger(IO_1 + "'st 1B IO element value: --------".PadRight(40 - IO_1.ToString().Length, '-') + " "  + IO_Element_1B);
                    }
                    ...
                    //LoggerInLogger("2 byte IO element in record: --------".PadRight(40, '-') + " " + IO_Elements_2B_Quantity);
                    ...
                    for (int IO_2 = 0; IO_2 < IO_Elements_2B_Quantity; IO_2++)
                    {
                        ...
                        //LoggerInLogger("IO element 2B ID: --------".PadRight(40, '-') + " "  + parameterID);
                        //LoggerInLogger(IO_2 + "'st 2B IO element value: --------".PadRight(40 - IO_2.ToString().Length, '-') + " "  + IO_Element_2B);
                    }
                    ...
                    //LoggerInLogger("4 byte IO element in record: --------".PadRight(40, '-') + " " + IO_Elements_4B_Quantity);
                    ...
                    for (int IO_4 = 0; IO_4 < IO_Elements_4B_Quantity; IO_4++)
                    {
                        ...
                        //LoggerInLogger("IO element 4B ID: --------".PadRight(40, '-') + " "  + parameterID);
                        //LoggerInLogger(IO_4 + "'st 4B IO element value: --------".PadRight(40 - IO_4.ToString().Length, '-') + " "  + IO_Element_4B);
                    }
                    ...
                    //LoggerInLogger("8 byte IO element in record: --------".PadRight(40, '-') + " " + IO_Elements_8B_Quantity);
                    ...
                    for (int IO_8 = 0; IO_8 < IO_Elements_8B_Quantity; IO_8++)
                    {
                        ...
                        //LoggerInLogger("IO element 8B ID: --------".PadRight(40, '-') + " "  + parameterID);
                        //LoggerInLogger(IO_8 + "'st 8B IO element value: --------".PadRight(40 - IO_8.ToString().Length, '-') + " "  + IO_Element_8B);
                    }
            ...
            //LoggerInLogger("CRC: -----".PadRight(40, '-') + " "  + CRC);
            ...
            //LoggerInLogger("Calculated CRC: -------".PadRight(40, '-') + " "  + calculatedCRC);
            //LoggerInLogger("||||||||||||||||||||||||||||||||||||||||||||||||");
            if (calculatedCRC == CRC)
                return numberOfData;
            else
            {
                //LoggerInLogger("Incorect CRC ");
                return 0;
            }
        }
